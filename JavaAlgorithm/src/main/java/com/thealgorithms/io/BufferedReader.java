...
/**
 * Mimics the actions of the Original buffered reader implements other actions, such as peek(n) to lookahead,
...
public class BufferedReader {
   ...
   /**
	* The maximum number of bytes the buffer can hold. Value is changed when encountered Eof to not cause overflow
	* read of 0 bytes
	*/
   ...
   /**
	* Removes the already read bytes from the buffer in-order to make space for new bytes to be filled up.
	* <p>
   ...
   /**
	* Reads one complete block of size {bufferSize} if found eof, the total length of an array will be that of
	* what's available
	*
